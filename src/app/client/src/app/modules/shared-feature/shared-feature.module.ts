...
import {
  ...
  TextbookListComponent, ProgramListComponent,
  OrgUsersListComponent, ContributorProfilePopupComponent
} from './components';
...
@NgModule({
  ...
  declarations: [ViewAllComponent, ProfileFrameworkPopupComponent, TermsAndConditionsPopupComponent,
    ...
    TextbookListComponent, OrgUsersListComponent, HelpPageComponent, ContributorProfilePopupComponent
  ],
  exports: [
    ViewAllComponent,
